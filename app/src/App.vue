...
export default {
    ...
    computed: {
      ...
      paperFilename() {
        ...
        return `${normalizedTitle} [Generated by papermaker.labs.zikani.me].${this.outputFormat}`
      },
    ...
    <van-tabs v-model:active="activeTabName">
      ...
      <van-tab title="About" name="aboutTab">
        <van-cell-group style="padding: 0.25em">
            <p>Paper Maker App  is an app that enables Teachers to create basic Examination papers on their mobile phone - it currently generates Word .docx Documents so that they can be edited. </p>
            ...
            <h4>How it works</h4>
            <p>This is built with some awesome technology: Go, VueJS, <a href="https://vant-ui.github.io/vant">VANT UI</a>, and WASM. Blog post coming soon at <a href="https://code.zikani.me">code.zikani.me</a></p>
        </van-cell-group>
        <van-cell-group>
